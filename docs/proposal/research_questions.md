...
* Construir indicadores dinámicos de diversificación productiva.  
...
La investigación se delimita a:
...
Configuraciones estructurales de los sistemas económicos caracterizadas por distintos grados de dependencia de recursos naturales no renovables.

La unidad de análisis no es el país, sino la **estructura económica observada en el tiempo**.

---

## Unidad empírica de observación

Los países se consideran unidades empíricas de observación que permiten identificar, medir y analizar configuraciones estructurales, pero no constituyen la unidad analítica central del estudio.
